...
<head>
    ...
    <title>ts-simple-ast - Order</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="nav-item active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/manipulation/order">Order</a></li>
...
<p>Change the order of certain nodes using the <code class="highlighter-rouge">.setOrder(newIndex: number)</code> method.</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">interfaceDeclaration</span> <span class="o">=</span> <span class="nx">sourceFile</span><span class="p">.</span><span class="nx">getInterfaceOrThrow</span><span class="p">(</span><span class="s2">"MyInterface"</span><span class="p">);</span>
<span class="nx">interfaceDeclaration</span><span class="p">.</span><span class="nx">setOrder</span><span class="p">(</span><span class="mi">2</span><span class="p">);</span>
</code></pre>
</div>

<p>Notice: Right now this is not supported on comma separated nodes. See <a href="https://github.com/dsherret/ts-simple-ast/issues/44">Issue #44</a> for more information.</p>
