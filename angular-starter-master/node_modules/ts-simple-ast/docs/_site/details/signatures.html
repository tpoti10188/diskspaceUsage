...
<head>
    ...
    <title>ts-simple-ast - Signatures</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/signatures">Signatures</a></li>
                                    <li>--</li>
...
<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">typeParams</span> <span class="o">=</span> <span class="nx">signature</span><span class="p">.</span><span class="nx">getTypeParameters</span><span class="p">();</span> <span class="c1">// returns: TypeParameter[]</span>
</code></pre>
</div>

<h3 id="parameters">Parameters</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">params</span> <span class="o">=</span> <span class="nx">signature</span><span class="p">.</span><span class="nx">getParameters</span><span class="p">();</span> <span class="c1">// returns: Symbol[]</span>
</code></pre>
</div>

<h3 id="return-type">Return Type</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">returnType</span> <span class="o">=</span> <span class="nx">signature</span><span class="p">.</span><span class="nx">getReturnType</span><span class="p">();</span>
</code></pre>
</div>

<h3 id="documentation-comments">Documentation Comments</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">docs</span> <span class="o">=</span> <span class="nx">signature</span><span class="p">.</span><span class="nx">getDocumentationComments</span><span class="p">();</span>
</code></pre>
</div>

<h3 id="js-doc-tags">JS Doc Tags</h3>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">tags</span> <span class="o">=</span> <span class="nx">signature</span><span class="p">.</span><span class="nx">getJsDocTags</span><span class="p">();</span>
</code></pre>
</div>
