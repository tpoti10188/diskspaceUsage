...
<head>
    ...
    <title>ts-simple-ast - Ambient</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/ambient">Ambient</a></li>
...
<p>Certain nodes in TypeScript can be ambient. For example, all nodes within a definition file are ambient.</p>

<h3 id="testing-if-ambient">Testing if ambient</h3>

<p>Use <code class="highlighter-rouge">isAmbient()</code>:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">isAmbient</span><span class="p">();</span> <span class="c1">// returns: boolean</span>
</code></pre>
</div>

<p>This will do several checks to see if it’s an ambient declaration.</p>

<h3 id="declare-keyword"><code class="highlighter-rouge">declare</code> keyword</h3>

<p>Check for the <code class="highlighter-rouge">declare</code> keyword:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">hasDeclareKeyword</span><span class="p">();</span> <span class="c1">// returns: boolean</span>
</code></pre>
</div>

<p>Or get the <code class="highlighter-rouge">declare</code> keyword if it exists:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">getDeclareKeyword</span><span class="p">();</span>
</code></pre>
</div>

<p>Or toggle the <code class="highlighter-rouge">declare</code> keyword on and off:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">toggleDeclareKeyword</span><span class="p">(</span><span class="kc">true</span><span class="p">);</span>
<span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">toggleDeclareKeyword</span><span class="p">(</span><span class="kc">false</span><span class="p">);</span>
<span class="nx">classDeclaration</span><span class="p">.</span><span class="nx">toggleDeclareKeyword</span><span class="p">();</span> <span class="c1">// toggles between true and false</span>
</code></pre>
</div>
