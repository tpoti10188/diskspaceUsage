...
<head>
    ...
    <title>ts-simple-ast - Async</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/async">Async</a></li>
...
<p>Certain nodes in TypeScript can have an <code class="highlighter-rouge">async</code> keyword modifier.</p>

<h3 id="is-async">Is async</h3>

<p>A node can be tested if it’s async using the <code class="highlighter-rouge">isAsync()</code> method:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">isAsync</span><span class="p">();</span> <span class="c1">// returns: boolean</span>
</code></pre>
</div>

<h3 id="async-keyword"><code class="highlighter-rouge">async</code> keyword</h3>

<p>Get the <code class="highlighter-rouge">async</code> keyword if it exists:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">getAsyncKeyword</span><span class="p">();</span>
</code></pre>
</div>

<h3 id="set-async">Set async</h3>

<p>Set if the declaration is async using <code class="highlighter-rouge">setIsAsync</code>:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="nx">functionDeclaration</span><span class="p">.</span><span class="nx">setIsAsync</span><span class="p">(</span><span class="kc">true</span><span class="p">);</span>
</code></pre>
</div>
