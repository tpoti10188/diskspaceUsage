...
<head>
    ...
    <title>ts-simple-ast - Literals</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/details/literals">Literals</a></li>
...
<ul>
  <li><code class="highlighter-rouge">StringLiteral</code> (ex. <code class="highlighter-rouge">"some string"</code>)</li>
  <li><code class="highlighter-rouge">NumericLiteral</code> (ex. <code class="highlighter-rouge">5</code>, <code class="highlighter-rouge">10.53</code>)</li>
  <li><code class="highlighter-rouge">BooleanLiteral</code> (ex. <code class="highlighter-rouge">true</code>)</li>
  <li><code class="highlighter-rouge">NoSubstitutionTemplateLiteral</code> (ex. <code class="highlighter-rouge">`some string`</code>)</li>
  <li><code class="highlighter-rouge">RegularExpressionLiteral</code> (ex. <code class="highlighter-rouge">/pattern/gi</code>)</li>
</ul>

<p>Methods:</p>

<ul>
  <li><code class="highlighter-rouge">.getLiteralValue()</code> - Returns the string, number, boolean, or RegExp value.</li>
  <li><code class="highlighter-rouge">isTerminated()</code> - If the literal is terminated.</li>
  <li><code class="highlighter-rouge">hasExtendedUnicodeEscape()</code> - If the literal has a unicode escape (ex. <code class="highlighter-rouge">\u{20bb7}</code>)</li>
</ul>
