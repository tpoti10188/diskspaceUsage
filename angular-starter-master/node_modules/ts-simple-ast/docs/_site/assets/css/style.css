...
.main { position: relative; margin-left: auto; margin-right: auto; padding-bottom: 50px; }
@media (min-width: 1200px) { .main { width: 1200px; max-width: 100%; padding-left: 15px; padding-right: 15px; } }

aside.warning { border: 1px dashed #bd4147; padding: 10px; }

nav { padding-top: 10px; line-height: 1.4rem; color: #73787b; }
nav ul { list-style-type: none; }
nav ul ul { padding-left: 20px; margin-top: 0px; padding-bottom: 5px; }
nav ul ul ul { margin-top: 0px; }
nav ul ul li { margin-bottom: 2px; }
nav ul li > a { color: #73787b; }
nav ul li > a:hover { text-decoration: none; }
nav ul li.active > a { color: #2266cc; }
nav .nav-link { padding: 0.3rem 0.5rem; }

header { padding-top: 2rem; padding-bottom: 0.5rem; }
header h1, header p { display: inline-block; }
header h1 { padding-left: 15px; padding-right: 10px; }
header .subText { color: rgba(0, 0, 0, 0.8); font-size: 0.9rem; }

h2 { font-size: 2.2rem; margin-bottom: 1rem; }
h2:not(:first-child) { padding-top: 1rem; }

h3 { padding-top: 1rem; color: #559955; }

h4 { color: #555; }

pre.highlight { padding: 8px 15px; background: #333; border-radius: 3px; border: 1px solid #c7c7c7; overflow: auto; overflow-y: hidden; }

code { font-family: Consolas, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace !important; }
