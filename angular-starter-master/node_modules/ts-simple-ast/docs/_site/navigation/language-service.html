...
<head>
    ...
    <title>ts-simple-ast - Language Service</title>
                        ...
                        <ul class="navbar-nav navbar-default">
                            ...
                            <li class="nav-item active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="/navigation/language-service">Language Service</a></li>
...
<p>Get the language service by calling:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">languageService</span> <span class="o">=</span> <span class="nx">ast</span><span class="p">.</span><span class="nx">getLanguageService</span><span class="p">();</span>
</code></pre>
</div>

<h3 id="underlying-compiler-object">Underlying compiler object</h3>

<p>The underlying <code class="highlighter-rouge">ts.LanguageService</code> can be retrieved as follows:</p>

<div class="language-typescript highlighter-rouge"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">tsLanguageService</span> <span class="o">=</span> <span class="nx">languageService</span><span class="p">.</span><span class="nx">compilerObject</span><span class="p">;</span>
</code></pre>
</div>

<h3 id="use">Use</h3>

<p>Generally you won’t need to use the language service, because most of the functionality is exposed as methods on the wrapped <code class="highlighter-rouge">Node</code> objects.</p>
