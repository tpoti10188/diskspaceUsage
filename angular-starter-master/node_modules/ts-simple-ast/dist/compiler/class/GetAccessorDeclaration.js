...
var GetAccessorDeclaration = /** @class */ (function (_super) {
    __extends(GetAccessorDeclaration, _super);
    ...
    GetAccessorDeclaration.prototype.getSetAccessor = function () {
        var parent = this.getParentIfKindOrThrow(ts.SyntaxKind.ClassDeclaration);
        var thisName = this.getName();
        try {
            for (var _a = __values(parent.getInstanceProperties()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var prop = _b.value;
